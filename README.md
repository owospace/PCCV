# PCCV
| PokeCube Current Version

This is a public repository which keeps track of the current PokeCube - Pixelmon Plus version.
It is useless on it's own, but is used by the [Koushin](https://github.com/owospace/Koushin) mod.

## Why?
 - To keep track of the PokeCube - Pixelmon Plus modpack version.
